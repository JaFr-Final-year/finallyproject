...
const Profile = () => {
  ...
  // Mock Data for "Rent Out Details" (Items the user is listing)
  const myListings = [
    { id: 101, name: 'Downtown Billboard', location: 'New York, NY', status: 'Active', price: '$500/mo' },
    { id: 102, name: 'Bus Stop Ad', location: 'Chicago, IL', status: 'Pending', price: '$300/mo' }
  ]
